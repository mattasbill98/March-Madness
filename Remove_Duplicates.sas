...
DATE: Tuesday, March 7, 2023     TIME: 12:43:16 AM
...
/*   START OF NODE: Remove_Duplicates   */
%LET _CLIENTTASKLABEL='Remove_Duplicates';
...
*/ Filtering out duplicates and some EDA */

*Filter out duplicates - first round data;
proc sort data=work.First_round out=First_Round_RD nodupkey;
    by season DayNum WTeamID LTeamID;
run;

*Filter out duplicates - Full Tourney data;
proc sort data=WORK.NCAAT_DETAILS_Full out=NCAAT_Details_Full_RD nodupkey;
	by season DayNum WTeamID LTeamID;
run;

*Filter out duplicates - Full Regular Season data;
proc sort data=WORK.JOINED_LTEAMS out=Regular_Season_Full_RD nodupkey;
	by season DayNum WTeamID LTeamID;
run;
