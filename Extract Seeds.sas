...
DATE: Tuesday, March 7, 2023     TIME: 12:41:55 AM
...
/*   START OF NODE: Extract Seeds   */
%LET _CLIENTTASKLABEL='Extract Seeds';
...
data seeds;
set MNCAATOURNEYSEEDS;
Tourney_Seed = substr(right(seed),3);
